            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        <h2>CONTACT INFO</h2>
                        <p>If there is a complaint please make a complaint at the address, telephone number, and email below. We eill provide a solution to these complaints. </p>
                        <ul>
                            <li>
                ...
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        <h2>GET IN TOUCH</h2>
                        <p>Please fill in the data below so you can submit the complaint you want</p>
                        <form id="contactForm">
                            <div class="row">
                                <div class="col-md-12">
