...
if(!empty($_GET["action"])){
    switch($_GET["action"]){
        case "checkout";
            ...
            $cart_item = "";
                foreach($_SESSION["cart_item"] as $item){
                    $cart_item = $cart_item . $item["code"] . "*" . $item["quantity"] . " ";
                }
                $db_handle->insertRow("INSERT INTO transactions (email, items) VALUES ('".$_SESSION["customer"]["email"]."', '".$cart_item."')");
		unset($_SESSION["cart_item"]);
            }
        break;
        case "login":
            $customerDB = $db_handle->runQuery("SELECT * FROM customers WHERE email='" . $_POST["InputEmail"] . "' AND password='" . $_POST["InputPassword"] . "'");
            
            if(!empty($customerDB)){
                $customer = array('name'=>$customerDB[0]["name"], 'email'=>$customerDB[0]["email"]);
        ...
        case "register":
            ...
            if(empty($db_handle->runQuery("SELECT FROM customers WHERE email='" . $email . "'"))){
                $db_handle->insertRow("INSERT INTO customers (name, email, password) VALUES ('".$name."', '".$email."', '".$password."')");
            }
        break;
    }
}
        ...
        <div class="container">
            <div class="row new-account-login">
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <form class="mt-3 collapse review-form-box" id="formLogin" method="post" action="checkout.php?action=login">
                        <div class="form-row">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <form class="mt-3 collapse review-form-box" id="formRegister" method="post" action="checkout.php?action=register">
                        <div class="form-row">
                            <div class="form-group col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="row">
                            ...
                            <div class="odr-box">
                                ...
                                if(isset($_SESSION["cart_item"])){
                                    ...
                                    <div class="media mb-2 border-bottom">
                                        <div class="media-body"> <a href="detail.php"> <?php echo $item["name"]; ?></a>
                        ...
                        <div class="col-12 d-flex shopping-box"> <a href="checkout.php?action=checkout" class="ml-auto btn hvr-hover">Place Order</a> </div>
                    </div>
                </div>
            </div>
