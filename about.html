...
<head>
    ...
    <!-- Site Metas -->
    <title>WILLMICH COLLECTION - Welocome to Our Store</title>
...
<body>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="right-phone-box">
                        <p>Call US :- <a href="#"> +62 888 09712577</a></p>
                    </div>
                    <div class="our-link">
                        <ul>
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h2 class="noo-sh-title">We are <span>WILLMICH COLLECTION</span></h2>
                    <p>Established in 2021, this website was created to fulfill the assignments for human & computer interaction cources in this 5th semester. An E-Commerce website that sells various types of clothing that will make you look more stylish, fashionable, modern, an of course attractive.</p>
            ...
            <div class="row my-5">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>We are Expert</h3>
                        <p>We have experience in retail. Trust us to change your appearance </p>
                    </div>
                </div>
            </div>
