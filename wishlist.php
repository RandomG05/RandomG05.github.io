        ...
        case "add":
            ...
            if(!empty($_SESSION["wishlist"])) {
			    foreach($_SESSION["wishlist"] as $k => $v) {
					    if($productByCode[0]["code"] == $k) unset($_SESSION["wishlist"][$k]);				
					    if(empty($_SESSION["wishlist"])) unset($_SESSION["wishlist"]);
			    }
		    }
        break;
	    case "remove":
		    if(!empty($_SESSION["wishlist"])) {
			    foreach($_SESSION["wishlist"] as $k => $v) {
					    if($_GET["code"] == $k) unset($_SESSION["wishlist"][$k]);				
					    if(empty($_SESSION["wishlist"])) unset($_SESSION["wishlist"]);
			    }
		    }
	    break;
                        ...
                        <table class="table">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="add-pr">
                                        <a class="btn hvr-hover" href="wishlist.php?action=add&code=<?php echo $item["code"]; ?>">Add to Cart</a>
                                    </td>
                                    <td class="remove-pr">
                                        <a href="wishlist.php?action=remove&code=<?php echo $item["code"]; ?>">
