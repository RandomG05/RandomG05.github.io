            ...
            <div class="row my-5">
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>OUR MISSION</h3>
                        <p>Making WILLMICH COLLECTION an E-Commerce website that is not only local but global by creating a store that continues to grow with the times. </p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>OUR VISION</h3>
                        <p>Make the appearance of E-Commerce more attractive to attract more customers and continue to develop types of clothing to make it look more fashionable. </p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>OUR PHILOSOPHY</h3>
                        <p>A shop that was built starting from a great desire to shop but wanted to have their own shop to process. </p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>We are Trusted</h3>
                        <p>Since it was built WILLMICH COLLECTION has been trusted for delivery according to the picture. </p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>We are Professional</h3>
                        <p>WILLMICH COLLECTION always delivers goods on time and according to the order and never disappoints. </p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>OUR STORIES</h3>
                        <p>Has many loyal customers who always believe in us and the products we offer. </p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-link-contact">
                            ...
                            <ul>
                                <li>
                                    <p><i class="fas fa-map-marker-alt"></i>Address: Jl Kp. Rawa Roko <br>Rawalumbu,<br> Kota Beksi 17116 </p>
                                </li>
                                <li>
